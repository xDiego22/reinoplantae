        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
                ...
                <div id="" class="bs-stepper">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <div id="habitat-part" class="content" role="tabpanel" aria-labelledby="habitat-part-trigger">
                            ...
                            <h5 class="text-wrap">¿En que tipo de habitat natural es mas probable encontrar esta planta?</h5>
                        ...
                        <div id="inflorescencia-part" class="content" role="tabpanel" aria-labelledby="inflorescencia-part-trigger">
                            ...
                            <h5 class="text-wrap">¿Cúal es el tipo de inflorescencia característico de esta planta?</h5>
                        ...
                        <div id="filogenia-part" class="content" role="tabpanel" aria-labelledby="filogenia-part-trigger">
                            ...
                            <h5 class="text-wrap">¿Cúal es la Filogenia de esta planta?</h5>
                            <div class="form-check">
                        ...
                        <div id="reproduccion-part" class="content" role="tabpanel" aria-labelledby="reproduccion-part-trigger">
                            ...
                            <h5 class="text-wrap">¿Cómo se reproduce principalmente esta planta?</h5>
            ...
            <div class="modal-footer">
                ...
                <div class="">
                    ...
                    <button type='button' id="anterior" class="btn btn-primary"><i class="bi bi-arrow-left me-2"></i>Anterior</button>
                    <button type='button' id="siguiente" class="btn btn-primary"> <i class="bi bi-arrow-right me-2"></i>Siguiente</button>
